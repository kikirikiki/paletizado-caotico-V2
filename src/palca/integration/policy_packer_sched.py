...
class PolicyPackerScheduler:
    ...
    def from_defaults(
        ...
        *,
        ...
        scheduler = SchedulerConfig(
            ...
            hard_floor_phase_height_balance_weight=hard_floor_phase_height_balance_weight,
    ...
    def collect_kpis(self) -> dict[str, object]:
        ...
        hard_floor_phase_height_balance_weight = float(
            getattr(self._scheduler.config, "hard_floor_phase_height_balance_weight", 0.0) or 0.0
        )
        ...
        hard_floor_phase_height_balance_applied_total = int(
            getattr(self._scheduler, "hard_floor_phase_height_balance_applied_total", 0) or 0
        )
        hard_floor_phase_height_balance_score_sum = float(
            getattr(self._scheduler, "hard_floor_phase_height_balance_score_sum", 0.0) or 0.0
        )
        hard_floor_phase_height_balance_score_max = float(
            getattr(self._scheduler, "hard_floor_phase_height_balance_score_max", 0.0) or 0.0
        )
        hard_floor_phase_height_balance_chosen_total = int(
            getattr(self._scheduler, "hard_floor_phase_height_balance_chosen_total", 0) or 0
        )
        ...
        kpis["hard_floor_phase_height_balance_weight"] = float(hard_floor_phase_height_balance_weight)
        ...
        kpis["hard_floor_phase_height_balance_applied_total"] = int(hard_floor_phase_height_balance_applied_total)
        kpis["hard_floor_phase_height_balance_score_mean"] = float(
            hard_floor_phase_height_balance_score_sum / max(1, hard_floor_phase_height_balance_applied_total)
        )
        kpis["hard_floor_phase_height_balance_score_max"] = float(hard_floor_phase_height_balance_score_max)
        kpis["hard_floor_phase_height_balance_chosen_total"] = int(hard_floor_phase_height_balance_chosen_total)

...
class PolicyPackerScheduler:
    ...
    def from_defaults(
        ...
        *,
        ...
        scheduler = SchedulerConfig(
            ...
            first_layer_planner_end_step=first_layer_planner_end_step,
            first_layer_planner_lookahead_items=first_layer_planner_lookahead_items,
        ...
        config = PolicyConfig(
            ...
            first_layer_planner_end_step=max(0, int(first_layer_planner_end_step)),
            first_layer_planner_lookahead_items=max(1, int(first_layer_planner_lookahead_items)),
    ...
    def collect_kpis(self) -> dict[str, object]:
        ...
        first_layer_planner_active_total = int(
            getattr(self._scheduler, "first_layer_planner_active_total", 0) or 0
        )
        first_layer_planner_floor_candidates_seen_total = int(
            getattr(self._scheduler, "first_layer_planner_floor_candidates_seen_total", 0) or 0
        )
        first_layer_planner_chosen_total = int(
            getattr(self._scheduler, "first_layer_planner_chosen_total", 0) or 0
        )
        first_layer_planner_stand_hw_chosen_total = int(
            getattr(self._scheduler, "first_layer_planner_stand_hw_chosen_total", 0) or 0
        )
        first_layer_planner_exit_no_floor_total = int(
            getattr(self._scheduler, "first_layer_planner_exit_no_floor_total", 0) or 0
        )
        first_layer_planner_score_sum = float(
            getattr(self._scheduler, "first_layer_planner_score_sum", 0.0) or 0.0
        )
        first_layer_planner_score_count = int(
            getattr(self._scheduler, "first_layer_planner_score_count", 0) or 0
        )
        ...
        kpis["first_layer_planner_active_total"] = int(first_layer_planner_active_total)
        kpis["first_layer_planner_floor_candidates_seen_total"] = int(first_layer_planner_floor_candidates_seen_total)
        kpis["first_layer_planner_chosen_total"] = int(first_layer_planner_chosen_total)
        kpis["first_layer_planner_stand_hw_chosen_total"] = int(first_layer_planner_stand_hw_chosen_total)
        kpis["first_layer_planner_exit_no_floor_total"] = int(first_layer_planner_exit_no_floor_total)
        kpis["first_layer_planner_score_mean"] = float(
            first_layer_planner_score_sum / max(1, first_layer_planner_score_count)
        )

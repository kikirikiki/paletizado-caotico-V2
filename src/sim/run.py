...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--largest-free-rect-weight",
        type=float,
        default=0.0,
        help=(
            "Peso (penalizacion) para placements que reducen el mayor rectangulo libre tras la colocacion "
            "(mejora relleno homogeneo)."
        ),
    )
    parser.add_argument(
        "--score-mode",
    ...
    *,
    ...
    if policy == "palca":
        ...
        decision_policy = PolicyPackerScheduler.from_defaults(
            ...
            largest_free_rect_weight=largest_free_rect_weight,
...
def main() -> None:
    ...
    payload = run_simulation(
        ...
        largest_free_rect_weight=float(args.largest_free_rect_weight),

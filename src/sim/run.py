...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="0=deshabilitado; N>0 suprime picks stacked (z>0) si hay candidatos en suelo durante los primeros N pasos del pallet.",
    )
    parser.add_argument(
        "--orientation-mode",
    ...
    *,
    ...
    payload: dict[str, Any] = {
        ...
        "params": {
            ...
            "floor_first_end_step": int(max(0, int(floor_first_end_step))),
            "orientation_mode": str(orientation_mode),
...
def main() -> None:
    ...
    payload = run_simulation(
        ...
        floor_first_end_step=int(args.floor_first_end_step),

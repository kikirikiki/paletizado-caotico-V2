...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="Rescate temprano: si la mejor opcion root apila, prioriza alternativa en suelo del mismo pallet hasta paso N (0 deshabilita).",
    )
    parser.add_argument(
        "--orientation-mode",
    ...
    *,
    ...
    payload: dict[str, Any] = {
        ...
        "params": {
            ...
            "early_floor_reorder_end_step": int(max(0, int(early_floor_reorder_end_step))),
            "orientation_mode": str(orientation_mode),
...
def main() -> None:
    ...
    payload = run_simulation(
        ...
        early_floor_reorder_end_step=int(args.early_floor_reorder_end_step),

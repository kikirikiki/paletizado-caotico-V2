...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Si se define, fuerza construcción por capas: solo candidatos con z <= min_z + band",
    )
    parser.add_argument(
        "--orientation-mode",
    ...
    *,
    ...
    if policy == "palca":
        ...
        decision_policy = PolicyPackerScheduler.from_defaults(
            ...
            z_band_mm=(max(0, int(z_band_mm)) if z_band_mm is not None else None),
    ...
    payload: dict[str, Any] = {
        ...
        "params": {
            ...
            "z_band_mm": (int(max(0, int(z_band_mm))) if z_band_mm is not None else None),
            "orientation_mode": str(orientation_mode),

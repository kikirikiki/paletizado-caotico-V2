...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--enforce-active-layer-first",
        action="store_true",
        help=(
            "Guardrail experimental: bloquea abrir capa superior si aun hay candidatos factibles "
            "en la capa activa (evaluada por base_z)."
        ),
    )
    parser.add_argument(
        "--orientation-mode",
...
def main() -> None:
    ...
    payload = run_simulation(
        ...
        enforce_active_layer_first=bool(args.enforce_active_layer_first),

...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="0 deshabilita; N>0 activa planner de base solo en los primeros N placements por pallet.",
    )
    parser.add_argument(
        "--first-layer-planner-lookahead-items",
        type=int,
        default=8,
        help="Max floor candidates por pallet evaluados por el planner de base.",
    )
    parser.add_argument(
        "--orientation-mode",
    ...
    *,
    ...
    payload: dict[str, Any] = {
        ...
        "params": {
            ...
            "first_layer_planner_end_step": int(max(0, int(first_layer_planner_end_step))),
            "first_layer_planner_lookahead_items": int(max(1, int(first_layer_planner_lookahead_items))),
            "orientation_mode": str(orientation_mode),
...
def main() -> None:
    ...
    payload = run_simulation(
        ...
        first_layer_planner_end_step=int(args.first_layer_planner_end_step),
        first_layer_planner_lookahead_items=int(args.first_layer_planner_lookahead_items),
